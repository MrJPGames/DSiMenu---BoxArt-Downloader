namespace DSiMenu___BoxArt_Downloader {
	partial class ManualMode {
		...
		private void InitializeComponent() {
			...
			this.button1.Text = "Download boxart";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.DownloadBoxArt);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.ChangeRomsDir);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(218, 64);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(29, 20);
			this.button3.TabIndex = 2;
			this.button3.Text = "...";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.ChangeOutputDir);
			// 
			// label1
			// 
			...
			this.label1.Text = "Roms directory (non recursive)";
			// 
			// textBox1
			// 
			...
			this.textBox1.Click += new System.EventHandler(this.ChangeRomsDir);
			// 
			// textBox2
			// 
			...
			this.textBox2.Click += new System.EventHandler(this.ChangeOutputDir);
			// 
			// label2
			// 
			...
			this.label4.Text = "Select inpit and output directories";
			// 
			// pictureBox1
			// 
